...
class gsp_utilityapp_vehicleindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/vehicle/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(vehicleList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(vehicleCount ?: 0)],-1)
printHtmlPart(13)
})
